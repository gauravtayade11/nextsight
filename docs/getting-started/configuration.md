...
See [backend/.env.example](https://github.com/gauravtayade11/nextsight/blob/main/backend/.env.example) for the complete list of environment variables with detailed comments.
